...
export class Data{
    public static DATA:DocumentPdf[] = [
        ...
        {id: 2, file: 'nombre archivo', solicitante: 'empleado 2', fecha: new Date, estado: 'finalizado', progreso: '2/3', isChecked: false},
        {id: 3, file: 'nombre archivo', solicitante: 'empleado 3', fecha: new Date, estado: 'finalizado', progreso: '2/3', isChecked: true},
        {id: 4, file: 'nombre archivo', solicitante: 'empleado 4', fecha: new Date, estado: 'finalizado', progreso: '2/3', isChecked: false},
        {id: 5, file: 'nombre archivo', solicitante: 'empleado 5', fecha: new Date, estado: 'finalizado', progreso: '2/3', isChecked: true},
